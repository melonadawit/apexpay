...
func GeneratePayslipPDFGo(data PayslipPDFData) ([]byte, error) {
	...
	// Employer Contributions — outstanding beyond RazorpayX
	pdf.SetFont("Helvetica", "B", 10)
