...
<p>Hello %s (%s),</p>
<p>Your magic link for employee self-service portal is ready. Expires in 24h, single use, HMAC SHA256 signed, hash stored sha256(salt+token) privacy like FIN, last4 %s, QR verification outstanding modern template logo pie chart YTD bilingual EN/AM Beyond ApexPay.</p>
...
<p>Thank you,<br/>ApexPay • አፔክስ • Payroll OS • ደሞዝ • enterprise-grade + Beyond</p>
</div>
</body></html>
`, e.FromName, e.FromEmail, req.ToName, req.ToEmail, subject,
