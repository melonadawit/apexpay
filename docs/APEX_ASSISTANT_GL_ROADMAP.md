...
> portals (vendor + customer)** ✅ · **UI/UX: merchant-web builds + language-aware titles
> + consistent states** ✅ · **checkout-web builds + clean customer copy** ✅.
> All roadmap items complete; admin-web (greenfield) tracked separately.
>
