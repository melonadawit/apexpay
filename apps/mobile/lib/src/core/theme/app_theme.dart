  ...
  static ThemeData light() {
    ...
    return base.copyWith(
      ...
      cardTheme: CardThemeData(
        elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24), side: BorderSide(color: Colors.black.withValues(alpha: 0.06))),
        color: Colors.white,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide(color: Colors.black.withValues(alpha: 0.08))),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.07), blurRadius: 30, offset: const Offset(0, 10))],
      ),
