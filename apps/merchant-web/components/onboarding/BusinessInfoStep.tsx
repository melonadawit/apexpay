    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2"><Label>Business Type • የንግድ አይነት *</Label>
          <select className="w-full rounded-xl border border-border h-12 px-3" value={data.business_type || "plc"} onChange={e => update("business_type", e.target.value)}>
        ...
        <div className="space-y-2"><Label>Industry • ዘርፍ *</Label>
          <select className="w-full rounded-xl border border-border h-12 px-3" value={data.industry || "e-commerce"} onChange={e => update("industry", e.target.value)}>
        ...
        <div className="md:col-span-2 space-y-2"><Label>Business Description • የንግድ መግለጫ *</Label><textarea className="w-full rounded-xl border border-border p-3 min-h-[80px]" placeholder="We sell ..." value={data.business_description || ""} onChange={e => update("business_description", e.target.value)} /></div>
