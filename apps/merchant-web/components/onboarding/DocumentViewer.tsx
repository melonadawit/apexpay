  ...
  return (
    <div className="rounded-2xl border bg-white overflow-hidden">
      <div className="p-3 bg-neutral-50 flex justify-between items-center">
        ...
        <span className="text-xs px-2 py-0.5 rounded-full bg-green-100">Hash integrity sha256 ✓ • Encrypted SSE-S3 • Presigned 15m</span>
      </div>

      <div className="grid grid-cols-2 gap-4 p-4">
        <div className="rounded-xl border bg-neutral-50 h-[400px] flex items-center justify-center">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border p-3 bg-white space-y-2 text-xs">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Status:</span><span className="px-2 py-0.5 rounded-full bg-amber-100">ocr_done → verified/rejected by compliance ops with rejection_reason</span></div>
          </div>
