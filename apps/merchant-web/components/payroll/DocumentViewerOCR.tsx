          ...
          <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="p-4 bg-white">
            ...
            <div className="mt-3 rounded-xl border bg-muted/30 p-3 max-h-96 overflow-auto">
              <div className="space-y-3 text-[11px]">
                ...
                <div className="flex justify-between"><span className="text-muted-foreground">TIN • 10-digit • ERCA Federal Numbering • 0098765432</span><span className="font-mono">{mockOCR.tin} • Valid ✓ • Regex ^[0-9]{{10}}$ • Checksum • Length 10 digits • Numeric 0-9</span></div>
