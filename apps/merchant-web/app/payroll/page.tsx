    ...
    <div className="min-h-screen bg-neutral-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="rounded-2xl border bg-white p-4"><p className="text-sm text-muted-foreground">Total Gross • አጠቃላይ</p><p className="text-2xl font-bold">ETB 200,000</p><p className="text-xs">10 employees • July 2026 regular</p></div>
          <div className="rounded-2xl border bg-white p-4"><p className="text-sm text-muted-foreground">Total Tax • ግብር</p><p className="text-2xl font-bold">ETB 20,000</p><p className="text-xs">ET brackets binary search O(log n) • 0-600 0% etc</p></div>
          <div className="rounded-2xl border bg-white p-4"><p className="text-sm text-muted-foreground">Total Net • የተጣራ</p><p className="text-2xl font-bold">ETB 150,000</p><p className="text-xs">Pension 7%/11% • OT 1.25/1.5/2.0</p></div>
        </div>
