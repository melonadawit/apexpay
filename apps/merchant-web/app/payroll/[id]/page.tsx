    ...
    <div className="min-h-screen bg-neutral-50 p-6">
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="px-3 py-1 rounded-full bg-amber-100">pending_approval • Needs dual if &gt;100k net</span>
        </div>

        <div className="rounded-2xl border bg-white overflow-hidden">
          <div className="grid grid-cols-8 gap-2 bg-neutral-50 p-3 text-xs font-semibold">
          ...
          {[
            ...
            <div key={i} className="grid grid-cols-8 gap-2 p-3 border-t text-xs hover:bg-neutral-50">
          ...
          <div className="grid grid-cols-8 gap-2 p-3 bg-neutral-50 font-bold text-xs sticky bottom-0">
        ...
        <div className="flex gap-2">
          <button className="rounded-xl bg-primary text-white px-6 h-12">Approve • dual finance+admin</button>
        ...
        <div className="rounded-2xl border bg-white p-4">
          ...
          <div className="mt-3 rounded-xl border p-4 bg-gradient-to-br from-white to-neutral-50 max-w-[400px]">
            ...
            <div className="mt-2 text-xs space-y-1">
              ...
              <div className="mt-2 h-10 bg-neutral-100 rounded flex items-center justify-center text-[10px]">Pie chart deductions • QR verification</div>
            </div>
          </div>
        </div>
      </div>
