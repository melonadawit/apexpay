      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="rounded-2xl border bg-white p-6 space-y-3">
            ...
            <button className="w-full rounded-xl bg-primary text-white h-12 font-semibold">Create Payout • pending_approval if &gt;50k • Ledger M3 Dr merchant_payable Cr clearing bank atomic per batch book</button>
          ...
          <div className="col-span-2 rounded-2xl border bg-white p-6 space-y-4">
        ...
        <div className="rounded-2xl border bg-white p-4">
          ...
          <div className="mt-3 space-y-2 text-sm">
            <div className="flex items-center justify-between rounded-xl border p-3"><span>pbat_01H • ETB 30,000 • 3 payouts • pending_approval • finance submitted admin approve needed • SWR poll 5s</span><span className="text-xs px-2 py-0.5 rounded-full bg-amber-100">pending_approval</span></div>
            <div className="flex items-center justify-between rounded-xl border p-3"><span>pbat_02H • ETB 10,000 • 1 payout • approved → processing → succeeded • ledger M3 balanced • Balances updated atomically per Tx • Outbox payout.succeeded + webhook payout.succeeded HMAC</span><span className="text-xs px-2 py-0.5 rounded-full bg-green-100">succeeded</span></div>
          </div>
        </div>
      </div>
    </div>
