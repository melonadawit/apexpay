      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="rounded-2xl border bg-card p-6 space-y-3">
            ...
            <button className="w-full rounded-xl bg-primary text-foreground h-12 font-semibold">Refund • M2 Dr payable R-FR + Dr fee_due FR Cr clearing R</button>
          ...
          <div className="col-span-2 rounded-2xl border bg-card p-4">
            ...
            <div className="mt-3 grid grid-cols-6 gap-2 bg-muted p-3 text-xs font-semibold"><span>Refund Ref</span><span>Payment</span><span>Amount</span><span>Fee Rev</span><span>Status</span><span>Ledger</span></div>
            <div className="grid grid-cols-6 gap-2 p-3 border-t text-xs"><span>ref_001</span><span>txr_01H</span><span>ETB 100.00</span><span>ETB 2.90 pro_rata</span><span><span className="px-2 py-0.5 rounded-full bg-green-500/20">succeeded</span></span><span>M2 balanced</span></div>
            <div className="mt-4 rounded-xl bg-blue-500/10 border border-blue-500/20 p-3 text-xs">
