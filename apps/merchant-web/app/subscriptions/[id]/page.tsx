        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2 space-y-4">
            ...
            <div className="rounded-2xl border bg-white p-4">
              ...
              <div className="mt-3 grid grid-cols-6 gap-2 bg-neutral-50 p-3 text-xs font-semibold"><span>Invoice</span><span>Amount</span><span>Status</span><span>Attempt</span><span>Next Attempt</span><span>Payment</span></div>
